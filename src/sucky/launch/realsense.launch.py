...
configurable_parameters = [{'name': 'camera_name',                  'default': 'd455', 'description': 'camera unique name'},
                           ...
                           {'name': 'initial_reset',                'default': 'true', 'description': 'reset device on startup'},
                           ...
                           {'name': 'gyro_fps',                     'default': '200', 'description': 'gyro stream fps (valid: 200, 400)'},
                           {'name': 'accel_fps',                    'default': '100', 'description': 'accel stream fps (valid: 100, 200, 400)'},
                           ...
                           {'name': 'pointcloud.allow_no_texture_points', 'default': 'true', 'description': 'allow points without texture'},
